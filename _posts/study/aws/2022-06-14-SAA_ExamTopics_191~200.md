...
Two things to remember regarding NAT Gateway :
#1) It is always placed in Public Subnet
...
Data is already in S3. Snowball is to transfer data from data center to AWS. Hence B & C are wrong
Lambda doesn't let you install custom software. So batch processing on S3 is not possible.
